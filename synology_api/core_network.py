...
class CoreNetwork(base_api.BaseApi):
    ...
    def traffic_control_router_rules_set(
        self,
        rules: str
    ) -> dict[str, object] | str:
        """
    ...
    # ------------------------------------------------------------------
    # SYNO.Core.Network.VPN — general VPN settings
    # ------------------------------------------------------------------

    def vpn_get(self) -> dict[str, object] | str:
        """
    ...
    # ------------------------------------------------------------------
    # SYNO.Core.Network.VPN.OpenVPN.CA — OpenVPN certificate authority
    # ------------------------------------------------------------------

    def vpn_openvpn_ca_get(self) -> dict[str, object] | str:
        """
    ...
    # ------------------------------------------------------------------
    # SYNO.Core.Network.VPN.OpenVPNWithConf — OpenVPN with config file
    # ------------------------------------------------------------------

    def vpn_openvpn_with_conf_get(self) -> dict[str, object] | str:
        """
    ...
    # ------------------------------------------------------------------
    # SYNO.Core.Network.VPN.OpenVPNWithConf.Certs — OpenVPN config certs
    # ------------------------------------------------------------------

    def vpn_openvpn_with_conf_certs_get(self) -> dict[str, object] | str:
        """
    ...
    def vpn_openvpn_with_conf_certs_set(
        self,
        cert_path: Optional[str] = None,
        key_path: Optional[str] = None,
        ca_path: Optional[str] = None
