...
class TestCoreStorage(unittest.TestCase):
    ...
    def test_iscsi_lun_set(self):
        self.instance.iscsi_lun_set(lun_id='test', name='test', description='test')
        self.instance.request_data.assert_called_once()
    ...
    def test_quota_set(self):
        self.instance.quota_set(volume_path='test', enabled=True, quota_mb='test')
        self.instance.request_data.assert_called_once()
    ...
    def test_storage_volume_set(self):
        self.instance.storage_volume_set(volume_path='test', description='test')
        self.instance.request_data.assert_called_once()
